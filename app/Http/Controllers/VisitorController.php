...
class VisitorController extends Controller
{
    ...
    public function MeetingScheduleIndex($company_user_id){
        ...
        if($already_requested_meeting != null && $already_requested_meeting->status == 'none' &&  Carbon::parse($already_requested_meeting->request_time)->toDateString() == Carbon::now()->toDateString()){
        ...
        elseif($already_requested_meeting != null && $already_requested_meeting->status == 'accepted' && Carbon::parse($already_requested_meeting->request_time)->toDateString() == Carbon::now()->toDateString()){
