...
@section('content')
    ...
    {{--                            @csrf--}}
    {{--                            <div class="form-group">--}}
    {{--                                <input class="form-control form-control-sm" type="password" placeholder="{{__('message.Old')}} {{__('message.password')}}"--}}
    {{--                                       name="OldPassword">--}}
    {{--                            </div>--}}
    {{--                            <div class="form-group">--}}
    {{--                                <input class="form-control form-control-sm" type="password" placeholder="{{__('message.New')}} {{__('message.password')}}"--}}
    {{--                                       name="password">--}}
    {{--                            </div>--}}
    {{--                            <div class="form-group">--}}
    ...
    {{--                                    style="width: 230px;color: rgb(255,255,255);">{{__('message.Update')}}--}}
    {{--                            </button>--}}
    {{--                            <i--}}
