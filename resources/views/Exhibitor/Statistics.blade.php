            ...
            <div style="width: 354px;height: 45px;background-color: #525252; margin-top: 70px" class="rounded">
                ...
                <div class="float-left border rounded" style="width: 244px;height: 452px;background-color: transparent;"><a
                    ...
                    <div>
                        ...
                        <div class="text-left user_active_menu" style="background-color: #00000000;height: 35px;margin-top: 1px;padding: 2px;padding-bottom: -1px;padding-top: -2px;padding-left: 13px;color: rgb(255,255,255);"><a class="text-left remove_underline" href="#" style="font-size: 20px;color: #000000;">{{__('message.Statistics')}}</a></div>
                ...
                <div class="border rounded d-block float-left border"
                    ...
                    <div class="table-responsive"
                        ...
                        <table class="table">
                            <thead>
                            <tr>
                                <th class="border rounded-0" style="width: 300px;">{{__('message.NumberofBoothVisits')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
