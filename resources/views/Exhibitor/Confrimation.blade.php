            ...
            <div style="width: 354px;height: 45px;background-color: #525252; margin-top: 70px" class="rounded">
                ...
                <div class="float-left border rounded" style="width: 244px;height: 452px;background-color: transparent;"><a href="#avatar_modal" data-toggle="modal">
                    ...
                    <div>
                        ...
                        <div class="text-left user_active_menu" style="background-color: #00000000;height: 35px;margin-top: 1px;padding: 2px;padding-bottom: -1px;padding-top: -2px;padding-left: 13px;color: rgb(255,255,255);"><a class="text-left remove_underline" href="#" style="font-size: 20px;color: #000000;">{{__('message.ConfirmationStatus')}}</a></div>
                ...
                <div class="border rounded d-block float-left border" style="width: 837px;height: 425px;background-color: rgba(168,168,168,0.57);padding: 7px;color: #363636;margin-left: 22px;margin-top: 13px;">
                    <div class="border rounded border-primary float-left border" style="background-color: #ffffff;height: 400px;width: 815px;margin-bottom: 0px;margin-left: 2px;padding: 2px;padding-top: -2px;margin-top: 6px;">
                        <div style="background-color: #c23838;height: 37px;">
                            <p class="border rounded" style="color: rgb(255,255,255);font-size: 24px;margin-bottom: 2px;background-color: #7abbb2;"><strong>{{__('message.Messages')}}</strong></p>
                        </div>
                        @if($Booth->User->AccountStatus == 'Active')
                            <h4><p class="nonoverflow" style="margin-top: 24px;padding: 16px;color: green">{{__('message.BoothActive')}}</p></h4>
                            @else
                            <h4><p class="nonoverflow" style="margin-top: 24px;padding: 16px;color: red">{{__('message.BoothDeactive')}}</p></h4>
