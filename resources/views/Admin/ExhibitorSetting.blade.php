            ...
            <div class="d-inline-block float-left" style="background-color: rgba(0,0,0,0);width: 1126px;height: 452px;margin-right: 46px;padding: 2px;padding-top: 0px;padding-right: 3px;">
                <div class="border rounded d-block float-left border" style="width: 230px;height: 480px;background-color: rgba(54,54,54,0.77);padding: 7px;color: #363636;padding-top: 7px;">
                    <div>
                        ...
                        <div class="text-left border rounded active-page" style="/*background-color: #00000000;*/height: 30px;margin-top: 1px;padding: 2px;padding-bottom: -1px;padding-top: -2px;padding-left: 13px;width: 216px;"><a class="text-left" href="#" style="color: #545454;">{{__('message.Exhibitor')}} {{__('message.Page')}}</a></div>
                        <div class="text-left" style="/*background-color: #00000000;*/height: 30px;margin-top: 1px;padding: 2px;padding-bottom: -1px;padding-top: -2px;padding-left: 13px;width: 216px;"><a class="text-left" href="{{route('Admin.AppAdjustment')}}" style="color: #b3b8b8;">{{__('message.App')}} {{__('message.Adjustment')}}<br></a></div>
                    </div>
                </div>
                <form class="form-inline" method="post" action="{{route('Admin.ExhibitorSettingPost')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="border rounded d-block float-left border" style="width: 843px;height: 452px;background-color: rgba(168,168,168,0.84);padding: 7px;color: #363636;margin-left: 22px;">
                        ...
                        <div style="background-color: transparent;height: 57px;width: 770px;margin-bottom: 0px;margin-left: 38px;padding: 25px;padding-top: 18px;margin-top: -20px;">
                            <div class="form-group text-left"><label style="color: rgb(255,255,255);margin-right: 23px;">{{__('message.BackgroundPicture')}}</label>
                                <input type="file" name="ExhibitorBackGround"></div>
                        </div>
                        ...
                        <div style="background-color: transparent;height: 367px;width: 770px;margin-bottom: 0px;margin-left: 38px;padding: 25px;padding-top: 18px;margin-top: -36px;">
                            <div class="form-group text-left" style="width: 578px;margin-bottom: 6px;">
                                <input class="border rounded form-control" type="text" style="width: 239px;margin-bottom: 5px" placeholder="Welcome" name="ExhibitorWelcome" value="{{$Site->ExhibitorWelcome}}">
                            </div>
                            <div class="row">
                                <div class="col">

                                    <textarea class="border rounded form-control form-control-lg float-left" style="width: 360px;height: 75px; margin-bottom: 10px" placeholder="About Exhibitor" name="ExhibitorAbout">{{$Site->ExhibitorAbout}}</textarea>
                            ...
                            <textarea class="border rounded form-control form-control-lg float-left" style="width: 360px;height: 67px;margin-bottom: 15px;" placeholder="About Payment" name="ExhibitorAboutPayment">{{$Site->ExhibitorAboutPayment}}</textarea>
                            ...
                            <div class="text-left float-left" style="padding-top: 15px;height: 32px;">
                                ...
                                <input class="border rounded form-control" type="text" style="width: 77px;padding: -3px;padding-left: 8px;margin-top: -21px;margin-bottom: 8px;margin-right: 7px;" placeholder="11" name="ExhibitorPayment" value="{{$Site->ExhibitorPayment}}">
                            ...
                            <button class="btn text-center float-right green-button" type="submit" style="width: 160px;/*background-color: #05c965;*/color: rgb(255,255,255);margin-top: 58px;">{{__('message.Save')}}</button></div>
                    </div>
                </form>
            </div>
        </div>
