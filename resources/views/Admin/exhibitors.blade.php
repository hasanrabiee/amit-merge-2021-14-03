            ...
            <div class="d-inline-block float-left"
                ...
                <div class="border rounded d-block float-left border"
                    ...
                    <div>
                        ...
                        <div class="text-left"
                             style="background-color: #00000000;height: 30px;margin-top: 1px;padding: 2px;padding-bottom: -1px;padding-top: -2px;padding-left: 13px;width: 216px;">
                            <a class="text-left" href="{{route('Admin.RegisteredVisitor')}}"
                ...
                <div class="border rounded d-block float-left border"
                    ...
                    <div class="border rounded d-inline float-left scroll_box"
                         style="width: 277px;height: 369px;margin-top: 4px;">
                        <form onblur="is_typing = false" onfocus="is_typing = true"
                              style="height: 7px;margin-bottom: 23px;width: 205px;"
                              action="{{route('Admin.RegisteredExhibitor')}}">
                            <div class="form-group" style="width: 402px;">
                                <input onblur="is_typing = false" onfocus="is_typing = true"
                                       class="form-control float-left" type="search"
                                       placeholder="{{__('message.Registered')}} {{__('message.Exhibitors')}} List"
                                       style="width: 222px;height: 33px;margin-bottom: 24px;" name="SearchTerm">
                        ...
                        @foreach($Booths as $booth)
                            <a href="?BoothID={{$booth->id}}">
                                ...
                                <div
                                    ...
                                    style="background-color: #c2c5c5;height: 40px;width: 258px;margin-left: 4px;margin-top: 5px;"
                                    @else
                                    ...
                                    <p class="text-left d-inline float-left"
                                       style="margin-top: 4px;margin-left: 6px;margin-right: 7px;color: #000000;">{{\Illuminate\Support\Str::limit($booth->CompanyName , 12)}}</p>
                                    <a href="?delete_group=99"></a>
                                    <div class="text-right border rounded float-right"
                                         style="height: 29px;width: 89px;margin-top: 4px;margin-right: 14px;padding: 0px;background-color: @if($booth->User->AccountStatus == 'Active') #05c965 @else #363636 @endif ;padding-left: 4px;">
                                        <p class="d-inline float-left"
                                           style="margin-right: 6px;color: rgb(255,255,255);">
                    ...
                    @if(request()->BoothID)
                        <div class="border rounded float-left"
                             style="width: 542px;height: 423px;margin-top: 5px;margin-left: 12px;background-color: #ffffff;">
                            <div class="border rounded border-dark"
                                 style="height: 260px;width: 527px;margin-left: 7px;margin-top: 9px;padding: 14px;padding-top: 7px;padding-bottom: -1px;">
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.Company')}} {{__('message.Name')}}
                                        :</strong>&nbsp;<span>{{$Booth->CompanyName}}</span></p>
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.Company')}} {{__('message.Representative')}}
                                        :&nbsp;</strong><span>{{$Booth->Representative}}</span></p>
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.WebSite')}}:&nbsp;</strong><span>{{$Booth->WebSite}}</span>
                                </p>
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.Position')}}
                                        :</strong>&nbsp;<span>{{$Booth->User->Position}}</span></p>
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.Tel')}}
                                        :</strong>&nbsp;<span>{{$Booth->User->PhoneNumber}}</span></p>
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.Country')}}
                                        :&nbsp;</strong><span>{{$Booth->User->Country}}</span></p>
                                <p class="text-left" style="color: #7b7b7b;margin-bottom: 5px;">
                                    <strong>{{__('message.email')}}:&nbsp;</strong><span>{{$Booth->User->email}}</span>
                                </p>
                                <div><a class="btn btn-primary btn-sm" role="button" data-toggle="modal"
                                        href="#job_vacan_mod" title="{{__('message.JobVacancies')}}"
                                        style="width: 142px;font-size: 17px;margin-right: 15px;">{{\Illuminate\Support\Str::limit(__('message.JobVacancies'), 10)}}</a>
                                    <a class="btn btn-primary btn-sm" role="button" data-toggle="modal"
                                       href="#operators_modal" title="{{__('message.Operators')}}"
                                       style="width: 142px;font-size: 17px;margin-right: 16px;">{{\Illuminate\Support\Str::limit(__('message.Operators'), 10)}} </a>
                                    <a class="btn btn-primary btn-sm" role="button" data-toggle="modal"
                                       href="#booth_info_modal" title="{{__('message.BoothInfo')}}"
                                       style="width: 142px;font-size: 17px;">{{\Illuminate\Support\Str::limit(__('message.BoothInfo'), 10)}} </a>
                                    <div class="modal fade" role="dialog" tabindex="-1" id="job_vacan_mod"
                                                    ...
                                                    <div class="col-md-12 search-table-col" style="margin-top: 4px;">
                                                        ...
                                                        <div
                                                            ...
                                                            <table class="table table-bordered table-hover">
                                                                ...
                                                                <tr>
                                                                    <th id="trs-hd"
                                                                        class="col-lg-1">{{__('message.Title')}}</th>
                                                                    <th id="trs-hd"
                                                                        class="col-lg-1">{{__('message.Description')}}</th>
                                                                    <th id="trs-hd"
                                                                        class="col-lg-2">{{__('message.Count')}}</th>
                                                                    <th id="trs-hd"
                                                                        class="col-lg-3">{{__('message.Salary')}} €
                                                                    </th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                ...
                                                                @foreach($Booth->Jobs as $job)
                                                                    <tr>
                                                                        <td>{{$job->Title}}</td>
                                                                        <td class="scroll_box"
                                                                            style="height: 101px;">{{$job->Description}}</td>
                                                                        <td>{{$job->Number}}</td>
                                                                        <td>{{$job->Salary}} €</td>
                                                                    </tr>
                                                                @endforeach
                            ...
                            <p class="text-left"
                               style="color: #7b7b7b;margin-bottom: 26px;margin-left: 12px;margin-top: 14px;font-size: 24px;width: 544px;">{{__('message.Payment')}}
                                :
                                @if($Booth->User->Payment == 'Paid')
                                    <button class="border rounded"
                                            style="margin-left: 30px;background-color: #05c965;color: rgb(255,255,255);padding: 0px;padding-right: 33px;padding-left: 36px;"
                                            onclick="areyousurePayment()">{{__('message.Paid')}}</button>
                                @else
                                    <button class="border rounded"
                                            style="margin-left: 30px;background-color: #e91515;color: rgb(255,255,255);padding: 0px;padding-right: 33px;padding-left: 36px;"
                                            onclick="areyousurePayment()">{{__('message.Unpaid')}}</button>
                                @endif
                            </p>
                            <form class="float-left" style="margin-left: 16px;height: 63px;margin-bottom: -25px;"
                                  action="{{route('Admin.SuspendBooth' , $Booth->id)}}">
                                <div class="form-group text-left" style="margin-bottom: 3px;height: -9px;">
                                    <p class="float-left" style="font-size: 19px;color: rgb(17,138,65);">
                                        <strong>{{__('message.ConfirmtheExhibitor')}}:</strong>
                                ...
                                <button class="btn btn-block float-right" type="submit"
                                        style="margin-bottom: 0px;margin-top: -9px;background-color: #05c965;color: rgb(255,255,255);">{{__('message.Save')}}</button>
                            </form>
                            <a onclick="event.preventDefault() ; return areyousure()" id="mysinsin_form"
                               href="{{route('Admin.RemoveExhibitor' , $Booth->id)}}">
                                <button class="btn  btn-danger float-right" type="button"
                                        style="margin-bottom: 0px;margin-top: 38px;margin-right: 10px;">{{__('message.DeleteCompany')}}</button>
                            </a>
                        </div>
                        <form id="mysinsin_form2" action="{{route('Admin.UserPaid')}}" method="post">
                            @csrf
