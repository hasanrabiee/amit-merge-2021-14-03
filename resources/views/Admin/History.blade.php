            ...
            <div class="d-inline-block float-left"
                ...
                <div class="border rounded d-block float-left border"
                    ...
                    <div>
                        ...
                        <div class="text-left active-page" style="background-color: #00000000;height: 30px;margin-top: 1px;padding: 2px;padding-bottom: -1px;padding-top: -2px;padding-left: 13px;width: 216px;color: #363636;"><a class="text-left" href="#" style="color: #b3b8b8;">{{__('message.History')}}</a></div>
                ...
                <div class="border rounded d-block float-left border"
                    ...
                    <div class="border rounded d-inline float-left scroll_box"
                        ...
                        <form style="height: 7px;margin-bottom: 23px;width: 205px;" action="{{route('Admin.History')}}">
                    ...
                    <p class="text-left"><strong>{{__('message.ChatHistory')}}:
                        ...
                        @if(request()->CompanyID || request()->UserID)
                            ...
                            @else
                                @foreach($Chats as $chat)
                                    <p class="@if($chat->Sender == 'Admin') text-right @else text-left @endif border rounded"
