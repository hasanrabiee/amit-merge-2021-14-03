                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-4">
                                                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                                ...
                                                                @if (\App\VisitorForm::first()->jobSeekerStatus == "active")
                                                                    <a class="nav-link active"  href="{{route("registerJobSeeker")}}">JOBSEEKER</a>
                                                                @endif
                                                        ...
                                                        <div class="col-md-8">
                                                            <form method="POST" action="{{ route('register') }}" class="w-100">
                                                                ...
                                                                <input type="text" hidden value="jobSeeker" name="formRule">
                                                                        ...
                                                                        <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="">
                                                                                        ...
                                                                                        <select class="form-control" name="Gender" required>
                                                                                            <option value="" selected disabled hidden>{{__('message.Select')}} Title</option>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input class="form-control" type="text"
                                                                                           style="background-color: rgb(255,255,255);" name="BirthDate" onfocus="(this.type='date')" value="{{old('BirthDate')}}" required>
                                                                                </div>
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select name="professionInterestedToApply" id="" class="form-control" required>

                                                                                        <option selected disabled hidden value="">Interested Profession</option>
                                                                                        @foreach(explode(',' , \App\VisitorForm::find(1)->professionInterestedItems) as $professionInterested)
                                                                                            <option value="{{$professionInterested}}" @if(old('professionInterestedToApply') == $professionInterested) selected @endif >{{$professionInterested}}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                                <div class="form-group">
