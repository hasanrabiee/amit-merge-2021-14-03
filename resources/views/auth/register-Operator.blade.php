                                                ...
                                                <div class="card" style="background-color:rgba(54,54,54,0.65);color: white">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <form method="POST" action="{{ route('Operator-Register') }}" class="w-100">
                                                                    @csrf
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <span><p class="text-white">{{__('message.passwordHint')}}</p></span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="submit" value="{{__('message.Register')}}" class="btn btn-success w-100">
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
