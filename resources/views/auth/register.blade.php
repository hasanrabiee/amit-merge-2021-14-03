...
@section('content')
    ...
    <div class="h-100 w-100 overflow" style="width:100% !important ; height:100% !important;background-size: cover;background-repeat:no-repeat;background-image: url('{{asset("assets/img/gradient.jpg")}}')">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-dark">{{__("message.testhanas")}} </h5><br>
                            </div>
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <!-- Traffic sources -->
                                                <h2 class="stroke-title text-white">{{__("message.VisitorRegistration")}}</h2>
                                                ...
                                                <div class="card" style="background-color:rgba(255,255,255,1);color: black;height: 1000px;position: relative">
                                                    <div class="card-body" style="font-size: 14px;">
                                                        <h3>{{\App\Site::first()->VisitorWelcome}}</h3>
                                                        <div class="row">
                                                            <div class="col-12 col-md-4">
                                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">

                                                                    @if (\App\VisitorForm::first()->studentStatus == "active")
                                                                        <a class="nav-link active"  href="{{route("register")}}">STUDENTS</a>
                                                                    @endif

                                                                    @if (\App\VisitorForm::first()->jobSeekerStatus == "active")
                                                                        <a class="nav-link"   href="{{route("registerJobSeeker")}}">JOBSEEKERS</a>
                                                                    @endif

                                                                    @if (\App\VisitorForm::first()->companyStatus == "active")
                                                                        <a class="nav-link" href="{{route("registerCompanyUser")}}">COMPANY INSTITUTION ORGANIZATION</a>
                                                                    @endif
                                                            ...
                                                            <div class="col-md-8">
                                                                    <form method="POST" action="{{ route('register') }}" class="w-100">
                                                                        @csrf
                                                                        <input type="text" hidden value="student" name="formRule">
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input class="form-control" type="text" required
                                                                                                   style="background-color: rgb(255,255,255);" name="BirthDate" onfocus="(this.type='date')" value="{{old('BirthDate')}}">
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select class="form-control"  name="Country"  required="">
                                                                                                ...
                                                                                                @else
                                                                                                    <option disabled Selected hidden value="">{{__('message.Select')}} {{__('message.Your')}} {{__('message.Country')}}</option>
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        ...
                                                                                        @if (\App\VisitorForm::first()->education == "active")
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="education" id="" class="form-control" required>
                                                                                                    <option selected disabled hidden value="">Choose Your Education Level</option>
                                                                                        ...
                                                                                        @if (\App\VisitorForm::first()->countryStudy == "active")
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                {{--                                                                                        <input type="text" class="form-control" placeholder="" value="{{old("countryStudy")}}">--}}

                                                                                                <select name="countryStudy" id="" class="form-control" required>
                                                                                                    <option selected disabled hidden value="">Interested Country</option>
                                                                                                    @foreach(explode(',' , \App\VisitorForm::find(1)->countryInterestedItems) as $interestedCountry)
                                                                                                        <option value="{{$interestedCountry}}" @if(old('countryStudy') == $interestedCountry) selected @endif >{{$interestedCountry}}</option>
                                                                                                    @endforeach
                                                                                        ...
                                                                                        @if (\App\VisitorForm::first()->InterestedDegree == "active")
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <select name="InterestedDegree" id="" class="form-control" required>
                                                                                        ...
                                                                                        @if (\App\VisitorForm::first()->InterestedField == "active")
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="InterestedField" id="" class="form-control" required>
                                                                                                    <option value="" disabled hidden selected>Interested Field</option>
                                                                                        ...
                                                                                        @if (\App\VisitorForm::first()->languageOfStudy == "active")
                                                                                            <div class="form-group">
                                                                                                <label for="" style="color: grey;line-height: 12px;font-size: 12px;">
                                                                                                    ...
                                                                                                    <span style="color: #006B63;font-size: 14px;">{{__("message.LanguageOfStudy")}}*</span>
                                                                                                    <br>
                                                                                                    {{__("message.EnterWhatLanguageDoYouPreferToStudy")}}

                                                                                                </label>
                                                                                                <textarea name="languageOfStudy" id="" cols="30" class="form-control"
                                                                                        ...
                                                                                        @if (\App\VisitorForm::first()->onlineDegreeProgram == "active")
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="onlineDegreeProgram" id="" class="form-control" required>
                                                                                                    <option value="" disabled selected hidden>Interested ?</option>
                                                                                                    @foreach(explode(',' , \App\VisitorForm::find(1)->onlineDegreeProgramsItems) as $onlineDegreeProgram)
                                                                                                        <option value="{{$onlineDegreeProgram}}" @if(old('onlineDegreeProgram') == $onlineDegreeProgram) selected @endif >{{$onlineDegreeProgram}}</option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                            </div>
                                                                                        @endif
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select name="admissionSemester" id="" class="form-control" required>
                                                                                                <option value="" disabled hidden selected>admission Semester</option>
                                                                                                @foreach(explode(',' , \App\VisitorForm::find(1)->admissionSemesterItems) as $admissionSemester)
                                                                                                    <option value="{{$admissionSemester}}" @if(old('admissionSemester') == $admissionSemester) selected @endif >{{$admissionSemester}}</option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label for="" style="color: grey;line-height: 12px;font-size: 12px;">
                                                                                                ...
                                                                                                <span style="color: #006B63;font-size: 14px;">{{__("message.InterNationalProgramInEnglish")}}*</span>
                                                                                                <br>

                                                                                                    {{__("message.IfYesInt")}}

                                                                                            </label>
                                                                                            <textarea name="interNationalPrograms" id="" cols="30" class="form-control"
                                                                                                      rows="3" required>{{old("interNationalPrograms")}}</textarea>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label for="" style="color: grey;line-height: 12px;font-size: 12px;">
                                                                                                ...
                                                                                                <span style="color: #006B63;font-size: 14px;">{{__("message.AreYouInterestedScholarship")}}*</span>
                                                                                                <br>
                                                                                                {{__("message.IfYesSch")}}
                                                                                            </label>
                                                                                            <textarea name="interestedScholarShip" id="" cols="30" class="form-control"
                                                                                                      rows="3" required>{{old("interestedScholarShip")}}</textarea>
                                                                                                ...
                                                                                                <div class="col-4">
                                                                                                    <select class="form-control w-100" style="width: 91px;" name="CountryCode" required>
                                                                                                        ...
                                                                                                        @else
                                                                                                            ...
                                                                                                            <option selected disabled value="" hidden>Code </option>
                                                                            ...
                                                                            <div class="row p-0 m-0">
                                                                                <div class="col-md-6">
                                                                                    <div class="custom-control custom-checkbox mt-2"><input type="checkbox" id="formCheck-1" required="" class=""><label
                                                                                            ...
                                                                                            <a style="font-weight:bolder;color:#0a6ebd;text-decoration:none" role="button" data-toggle="modal"
                                                            ...
                                                            <form method="POST" action="{{ route('register') }}" class="w-100">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" placeholder="" name="userCompanyName" required value="{{old("userCompanyName")}}">
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="">
                                                                                        Position Within in the Company/Institution/Organization*
                                                                                    </label>
                                                                                    <input type="text" class="form-control" placeholder="" name="position" required value="{{old("position")}}">
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="">
                                                                                        Company Address , Street and House Number *
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="">
                                                                                        Main Company / Institution Email*
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label for="">
                                                                                        Profile / Nature Of Your Company / Institution / Organization*
                                                                                    </label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="custom-control custom-checkbox mt-2"><input type="checkbox" id="formCheck-1" required="" class=""><label
                                                                                class="" for="formCheck-1">
                                                                                <a style="color:#0a6ebd;text-decoration:none" role="button" data-toggle="modal"
                                                                                   href="#myModal" class="ml-3">{{__('message.TACI')}}</a>
                                                                            </label>
                                                                        </div>
                                                                    </div>
