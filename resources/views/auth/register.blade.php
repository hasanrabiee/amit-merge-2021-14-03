                                                                ...
                                                                <form method="POST" action="{{ route('register') }}" class="w-100">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" placeholder="{{__('message.ln')}} *"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="password" placeholder="{{__('message.password')}} *"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="{{__('message.BirthDate')}}"
                                                                                       style="background-color: rgb(255,255,255);" name="BirthDate" onfocus="(this.type='date')" value="{{old('BirthDate')}}">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="email" placeholder="{{__('message.email')}} *" required=""
                                                                            ...
                                                                            <div class="form-group">
                                                                                <select class="form-control"  name="Country"  required="">
                                                                                    ...
                                                                                    @else
                                                                                        <option disabled Selected>{{__('message.Select')}} {{__('message.Your')}} {{__('message.Country')}}</option>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="{{__('message.Select')}} {{__('message.City')}} *" required=""
