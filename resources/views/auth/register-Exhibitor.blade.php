...
@section('content')
    <header class="d-flex masthead"
        ...
        <div class="container my-auto text-center">
            ...
            <h3 class="mb-5"></h3>
            <div class="amitiss_back" style="width: 1117px;height: 397px;margin-right: 10px; ">
                <div class="d-inline float-left">
                    <h2 style="width: 183px;margin-top: 30px;color: rgb(255,255,255);">{{\App\Site::find(1)->ExhibitorWelcome}}</h2>
                    <p class="text-left"
                       style="background-size: auto;width: 313px;padding-left: 20px;color: rgb(255,255,255);margin-bottom: 0px;">
                        @if(\App\Site::find(1)->ExhibitorAbout)
                            {{\App\Site::find(1)->ExhibitorAbout}}
                        @else
                            Exhibitor register text
                        @endif
                    </p>
                </div>
                <div style="width: 1053px;height: 235px;">
                    <form aria-invalid="mysinsin_form" onsubmit="event.preventDefault(); areyousure();"
                          id="mysinsin_form" action="{{route('Exhibitor-Register-One')}}" method="post">
                        @csrf
                        <div class="float-left" style="margin-right: 38px;width: 278px;margin-top: 37px;">
                            ...
                            <div class="form-group" style="height: 22px;">
                                <input class="form-control form-control-sm" type="text"
                                       placeholder="{{__('message.CompanyName')}} *"
                                       required="" style="background-color: rgb(255,255,255);" name="CompanyName"
                                       value="{{old('CompanyName')}}">
                            </div>
                            <div class="form-group" style="height: 22px;">
                                <input class="form-control form-control-sm" type="text"
                                       placeholder="{{__('message.CompanyRepresentative')}} *"
                                       required=""
                                       style="background-color: rgb(255,255,255);" name="Representative"
                            ...
                            <div class="form-group" style="height: 22px;">
                                <input class="form-control form-control-sm" type="text"
                                       placeholder="{{__('message.Position')}}"
                                        style="background-color: rgb(255,255,255);" name="PositionUser"
                            ...
                            <div class="form-group text-justify" style="height: 22px;margin-top: -6px;line-height:15px">
                                <small class="text-light" style="line-height: 1">{{__('message.passwordHint')}}</small>
                            </div>

                        </div>
                        <div class="float-left" style="margin-top: 35px;">
                            ...
                            <div class="form-group" style="height: 22px;">
                                <select class="custom-select custom-select-sm"
                                    ...
                                    @else
                                        <option selected disabled>{{__('message.Country')}} *</option>
                                    @endif
                            ...
                            <div class="form-group" style="height: 22px;">
                                ...
                                <input class="form-control form-control-sm" maxlength="35" type="text"
                                       placeholder="{{__('message.YourCompanyWebSite')}} "
                                       style="background-color: rgb(255,255,255);" name="WebSite" id="WebSite"
                                       value="{{old('WebSite')}}">
                                ...
                                <div class="d-inline float-left">
                                    <select class="custom-select custom-select-sm" style="width: 91px;"
                                        ...
                                        @if(old('CountryCode'))
                                            ...
                                            <option value="{{old('CountryCode')}}" selected>{{old('CountryCode')}}</option>
                                        @else
                            ...
                            <div class="form-group" style="margin-top: 9px;">
                                ...
                                <div class="form-group">
                                    <div><a class="btn btn-primary btn-lg hidden_class" role="button"
                                            data-toggle="modal" href="#myModal">Launch Demo Modal</a>
